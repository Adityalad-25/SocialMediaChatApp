...
class LinkedListElement {
    ...
    get next() {
        if (this.$NEXT == null) {
            throw new InvalidOperationError_js_1.default('LinkedList Error: Accessing Next Element is Null');
        }
        return this.$NEXT;
    }
    set next(element) {
    ...
    get prev() {
        if (this.$PREV == null) {
            throw new InvalidOperationError_js_1.default('LinkedList Error: Accessing Previous Element is Null');
        }
        return this.$PREV;
    }
    set prev(element) {
...
class LinkedList {
    ...
    get frontElement() {
        if (this.FIRST_ELEMENT === null) {
            throw new InvalidOperationError_js_1.default('LinkedList Error: Accessing First Element, which is null');
        }
        return this.FIRST_ELEMENT;
    }
    get backElement() {
        if (this.LAST_ELEMENT === null) {
            throw new InvalidOperationError_js_1.default('LinkedList Error: Accessing Last Element, which is null');
        }
    ...
    popBack() {
        if (this.LAST_ELEMENT === null) {
            throw new InvalidOperationError_js_1.default('LinkedList Error: Pop Back Null Element');
        }
    ...
    popFront() {
        if (this.FIRST_ELEMENT === null) {
            throw new InvalidOperationError_js_1.default('LinkedList Error: Pop Front Null Element');
        }
    ...
    toArray() {
        ...
        while (itr === null || itr === void 0 ? void 0 : itr.hasNext) {
            itr = itr.next;
            result.push(itr.value);
        }
        return result;
